...
teams_by_group = Utils.teams_by_group_array(number_of_teams, number_of_groups)
rounds_games = Utils.calculate_rounds_and_games(Utils(), number_of_teams, number_of_groups, teams_to_kncockout)
